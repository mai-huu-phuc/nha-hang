 ...
 <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Quản lý loại hải sản</a></li>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
            <a href="./AddTypeFood.php" style="width:200px;" class="btn btn-primary">Thêm</a>
            <a id="deleteMulti" style="width:200px;" class="btn btn-danger">Xóa Nhiều</a>
        </div>
        <div class="row">
            <div class="col-md-12">
                <table id="loadTypeFood" class="row-border">
                    <thead>
                        <tr>
...
<script type="text/javascript ">  
    $( document ).ready(function() {
        let table2 = $('#loadTypeFood').DataTable({});

        LoadDataSend();

        table2.on('click', 'button', function (e) {
            table2 = $('#loadTypeFood').DataTable();
        ...
        $("#deleteMulti").click(() => {
            if (confirm("bạn có chắc muốn thêm không")) {
                ...
                if (user_idArray.length > 0) {
                    $.ajax({
                        type: "POST",
                        url: "./js/deleteMultiTypeFood.php",
                        data: datasend,
...
function LoadDataSend() {
    ...
    $.ajax({
        type: "POST",
        url: "./js/LoadTypeFood.php",
        success: function(response) {
       
            if ($.fn.dataTable.isDataTable('#loadTypeFood')) {

                $('#loadTypeFood').DataTable().clear().destroy();
                let stt = 0;
                table2 = $('#loadTypeFood').DataTable({
                    language: {
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                ...
                                return '<a href="./detailTypeFood.php?id='+row.id+'" >' + id_active + '<a >';
                            },
                            width: "20%",
                        },
                        {
