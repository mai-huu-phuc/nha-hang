<?php 
    ...
    if (isset($_GET["id"])) {
      ...
      $query_get_id = "SELECT `id`, `nameTypeBaiViet`, `isBlock` FROM `typebaiviet` where id=".$_GET["id"]." LIMIT 1";
            ...
            <div class="card card-primary">
              ...
              <div class="card-body" style="display: block;">
                <div class="form-group">
                  ...
                  <input type="text" id="nameFood" name="nameFood" class="form-control" value="<?php echo  $showthongtin['nameTypeBaiViet'] ?>">
                </div>
                <div class="form-group">
