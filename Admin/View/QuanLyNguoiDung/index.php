 ...
 <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
            <a href="./AddUser.php" style="width:200px;" class="btn btn-primary">Thêm</a>
            <a id="deleteMulti" style="width:200px;" class="btn btn-danger">Xóa Nhiều</a>
        </div>
        <div class="row">
            <div class="col-md-12">
                <table id="loadAccount" class="row-border">
                    <thead>
                        <tr>
...
<script type="text/javascript ">  
    $( document ).ready(function() {
        let table2 = $('#loadAccount').DataTable({});

        LoadDataSend();

        table2.on('click', 'button', function (e) {
            table2 = $('#loadAccount').DataTable();
                ...
                if (data["id"] != null) {
                if(confirm("Bạn có chắc muốn xóa: "+data["UserName"]))
                {
                    $.ajax({
                        type: "POST",
                        url: "./js/DeleteUser.php",
                        data: messengerData,
...
function LoadDataSend() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if ($.fn.dataTable.isDataTable('#loadAccount')) {

                $('#loadAccount').DataTable().clear().destroy();
                let stt = 0;
                table2 = $('#loadAccount').DataTable({
                    language: {
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                ...
                                return '<a href="./detailUser.php?id='+row.id+'" >' + id_active + '<a >';
                            },
                            width: "20%",
                        },
                        {
