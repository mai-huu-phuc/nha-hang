 ...
 <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Quản lý loại bài viết</a></li>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
            <a href="./AddTypeC.php" style="width:200px;" class="btn btn-primary">Thêm</a>
