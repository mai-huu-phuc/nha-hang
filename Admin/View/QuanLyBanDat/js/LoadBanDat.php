...
header('Content-Type:application/json');
    ...
    $querry_donvi = 'SELECT donhang.id, `Ban_id`,  `ngayTao`, `thoiGianGiao`, `ghiChu`, `thanhToan`, `maKhuyenMai`, `thoiGianKetThuc`,
    `datBan`,account.name,banan.tenBan  FROM `donhang`, account, banan WHERE account.id=Acc_id and banan.id=Ban_id and datBan=1 order by donhang.id';
    // echo $querry_donvi;
