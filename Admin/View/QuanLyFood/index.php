 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Quản Lý món ăn </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
            <a href="./AddF.php" style="width:200px;" class="btn btn-primary">Thêm</a>
            <a id="deleteMulti" style="width:200px;" class="btn btn-danger">Xóa Nhiều</a>
        </div>
        <div class="row">
            <div class="col-md-12">
                <table id="loadFood" class="row-border">
                    <thead>
                        <tr>
...
<script type="text/javascript ">  
    $( document ).ready(function() {
        let table2 = $('#loadFood').DataTable({});

        LoadDataSend();

        table2.on('click', 'button', function (e) {
            table2 = $('#loadFood').DataTable();
...
function LoadDataSend() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if ($.fn.dataTable.isDataTable('#loadFood')) {

                $('#loadFood').DataTable().clear().destroy();
                let stt = 0;
                table2 = $('#loadFood').DataTable({
                    language: {
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                ...
                                return '<a href="./detailF.php?id='+row.id+'" >' + id_active + '<a >';
                            },
                            width: "20%",
                        },
                        {
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                let nameActive = '';
                                if (row.isNoiBat != null) {
                                    nameActive = row.isNoiBat;
                                }
                                return '<b>' + nameActive + '</b>';
                            },
                        },
