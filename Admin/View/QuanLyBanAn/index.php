 ...
 <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
            <a href="./AddTypeT.php" style="width:200px;" class="btn btn-primary">Thêm</a>
            <a id="deleteMulti" style="width:200px;" class="btn btn-danger">Xóa Nhiều</a>
        </div>
        <div class="row">
            <div class="col-md-12">
                <table id="loadTypeTable" class="row-border">
                    <thead>
                        <tr>
...
<script type="text/javascript ">  
    $( document ).ready(function() {
        let table2 = $('#loadTypeTable').DataTable({});

        LoadDataSend();

        table2.on('click', 'button', function (e) {
            table2 = $('#loadTypeTable').DataTable();
...
function LoadDataSend() {
    ...
    $.ajax({
        type: "POST",
        url: "./js/LoadTypeT.php",
        success: function(response) {
       
            if ($.fn.dataTable.isDataTable('#loadTypeTable')) {

                $('#loadTypeTable').DataTable().clear().destroy();
                let stt = 0;
                table2 = $('#loadTypeTable').DataTable({
                    language: {
