 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Quản lý thanh Menu</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Quản lý Thanh Menu </a></li>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
            <a href="./Create.php" style="width:200px;" class="btn btn-primary">Thêm</a>
            <a id="deleteMulti" style="width:200px;" class="btn btn-danger">Xóa Nhiều</a>
        </div>
        <div class="row">
            <div class="col-md-12">
                <table id="loadTypeContent" class="row-border">
                    <thead>
                        <tr>
...
<script type="text/javascript ">  
    $( document ).ready(function() {
        let table2 = $('#loadTypeContent').DataTable({});

        LoadDataSend();

        table2.on('click', 'button', function (e) {
            table2 = $('#loadTypeContent').DataTable();
                ...
                if (data["id"] != null) {
                if(confirm("Bạn có chắc muốn xóa: "+data["nameFood"]))
                {
                    $.ajax({
                        type: "POST",
                        url: "./js/delete.php",
...
function LoadDataSend() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if ($.fn.dataTable.isDataTable('#loadTypeContent')) {

                $('#loadTypeContent').DataTable().clear().destroy();
                let stt = 0;
                table2 = $('#loadTypeContent').DataTable({
                    language: {
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                ...
                                return '<a href="./detail.php?id='+row.id+'" >' + id_active + '<a >';
                            },
                            width: "20%",
                        },
                        {
